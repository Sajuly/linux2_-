...
## 7. NAT
* В файле /etc/apache2/ports.conf на ws22 && r1 изменить строку Listen 80 на Listen 0.0.0.0:80, то есть сделать сервер Apache2 общедоступным
`sudo apt install apache2`<br>
![версия ubuntu](scr7.1.PNG)<br>
* Запустить веб-сервер Apache командой service apache2 start на ws22 и r1
![версия ubuntu](scr7.2.PNG)<br>
* Добавить в фаервол, созданный по аналогии с фаерволом из Части 4, на r2 следующие правила:<br>
Создать файл /etc/firewall.sh, имитирующий фаерволл<br>
...
![версия ubuntu](scr7.3.PNG)<br>
* Запускать файл также, как в Части 4
![версия ubuntu](scr7.4.PNG)<br>
* Проверить соединение между ws22 и r1 командой ping (При запуске файла с этими правилами, ws22 не должна "пинговаться" с r1)
![версия ubuntu](scr7.5.PNG)<br>
* Добавить в файл ещё одно правило:<br>
4) Разрешить маршрутизацию всех пакетов протокола ICMP<br>
![версия ubuntu](scr7.6.PNG)<br>
Запускать файл также, как в Части 4
![версия ubuntu](scr7.6.1.PNG)<br>
Проверить соединение между ws22 и r1 командой ping (При запуске файла с этими правилами, ws22 должна "пинговаться" с r1)<br>
![версия ubuntu](scr7.7.PNG)<br>
* Добавить в файл ещё два правила:<br>
5) Включить SNAT, а именно маскирование всех локальных ip из локальной сети, находящейся за r2 (по обозначениям из Части 5 - сеть 10.20.0.0) Совет: стоит подумать о маршрутизации внутренних пакетов, а также внешних пакетов с установленным соединением.<br>
...
![версия ubuntu](scr7.8.PNG)<br>
апускать файл также, как в Части 4
![версия ubuntu](scr7.6.1.PNG)<br>
